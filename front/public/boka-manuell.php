...
<HTML>
 ...
 <a href="/"><input class="no-print" type="button" value="Huvudmeny - Bokningar" style="font-size:18px;"></a>
 ...
 <!-- START TOP FIELD -->
 <img src="../img/rekalogga-small.jpg" style="float:left;padding-right:35mm">
 ...
 <table style="padding:0px;margin:0px;margin-top:-15mm;">
 ...
 <br>
 <hr style="padding:0px;margin:0px;margin-top:10mm;border-style:solid;border-width:1px;width:170mm">
 <small>
 ...
 echo "<img src='../img/rekalogga-small.jpg' style='float:left;padding-right:35mm'>";
 ...
 echo "Box 8797<br>";
 echo "402 76 Göteborg<br>";
 echo "</small>";
 echo "</td>";
 echo "<td style='padding:0px;margin:0px;width:38mm;vertical-align:top;text-align:left'>";
 echo "<small>";
 echo "<b>Besöksadress</b><br>";
 echo "Aröds Industriväg 30<br>";
 echo "Hisings Backa<br>";
 echo "</small>";
 echo "</td>";
 ...
 echo "031-22 21 20<br>";
 echo "www.rekoresor.se<br>";
 echo "info@rekoresor.se";
 echo "</td></tr></table>";
 echo "</small>";
 echo "</td>";
 echo "<td style='padding:0px;margin:0px;width:55mm;vertical-align:top;text-align:left'>";
